...
class DemoData_model extends CI_Model
{
    public function get_home_data()
    {
        ...
        return array(
            ...
            'stats' => array(
                array('value' => '1,000+', 'label' => 'Campaigns Booked', 'detail' => 'Successful ad placements'),
                array('value' => '50+', 'label' => 'Cinemas', 'detail' => 'Partner locations in DE'),
                array('value' => '1M+', 'label' => 'Weekly Reach', 'detail' => 'Engaged moviegoers'),
                array('value' => '20+', 'label' => 'Years Experience', 'detail' => 'Industry expertise'),
            ),
            'steps' => array(
                array(
                    'number' => '1',
            ...
            'showcase' => array(
                ...
                'cards' => array(
                    array('title' => 'Drama', 'variant' => 'warm'),
                    array('title' => 'Noir Nights', 'variant' => 'dark'),
                    array('title' => 'Featured Premiere', 'variant' => 'featured', 'image' => 'assets/Images/Home_banner.png'),
                    array('title' => 'Poetry in Motion', 'variant' => 'accent'),
                    array('title' => 'City Stories', 'variant' => 'light'),
                ),
            ),
            'benefits' => array(
                array(
